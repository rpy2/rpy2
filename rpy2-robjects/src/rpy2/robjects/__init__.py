...
def _convert_rpy2py_floatvector(obj):
    clsmap = (conversion.converter_ctx.get()
              .rpy2py_nv_map[rinterface.FloatSexpVector])
    cls = clsmap.find(obj.rclass)
    return cls(obj)
...
def _convert_rpy2py_complexvector(obj):
    clsmap = (conversion.converter_ctx.get()
              .rpy2py_nv_map[rinterface.ComplexSexpVector])
    cls = clsmap.find(obj.rclass)
    return cls(obj)
...
def _convert_rpy2py_boolvector(obj):
    clsmap = (conversion.converter_ctx.get()
              .rpy2py_nv_map[rinterface.BoolSexpVector])
    cls = clsmap.find(obj.rclass)
    return cls(obj)
...
def _rpy2py_listsexp(obj):
    clsmap = (conversion.converter_ctx.get()
              .rpy2py_nv_map[rinterface.ListSexpVector])
    cls = clsmap.find(obj.rclass)
    return cls(obj)
...
def _rpy2py_sexpextptr(obj):
    clsmap = (conversion.converter_ctx.get()
              .rpy2py_nv_map[rinterface.SexpExtPtr])
    cls = clsmap.find(obj.rclass)
    return cls(obj)
